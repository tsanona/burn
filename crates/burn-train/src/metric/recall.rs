...
impl<B: Backend> Metric for RecallMetric<B> {
    ...
    fn update(
        ...
        let metric =
            ConfusionStats::new(predictions, targets, self.threshold, self.top_k, self.class_average).recall();
...
mod tests {
    ...
    #[case::multiclass_macro(Multiclass, Macro, (0.5 + 1.0 + 0.5)/3.0)]
    #[case::multilabel_micro(Multilabel, Micro, 5.0/9.0)]
    #[case::multilabel_macro(Multilabel, Macro, (2.0/4.0 + 1.0 + 1.0/3.0)/3.0)]
    fn test_recall(
